...
const TEST_PALLETTE: [[u8; 3]; 4] = [[0, 0, 0], [50, 50 , 50], [150, 150, 150], [255, 255, 255]];
...
fn test_bootrom() -> Result<(), image::ImageError> {
    ...
    let mut cartridge_bytes = [0u8; 257];
    ...
    let memory = Rc::new(RefCell::new(GBMemory::with_bootrom(bootrom, cartridge, sound_controller)));
